...
My.Location <- "C:/Users/Abheek Sinha/study materials/Business Analytics MSBA - San Diego/6.Collecting and Analyzing large datasets/DataDriven-Competition/Predict Blood Donations"
setwd(My.Location)
